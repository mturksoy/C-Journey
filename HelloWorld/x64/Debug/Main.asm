...
PUBLIC	?LogMultiply@@YAXH@Z				; LogMultiply
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?LogMultiply@@YAXH@Z DD imagerel $LN3
	DD	imagerel $LN3+75
	DD	imagerel $unwind$?LogMultiply@@YAXH@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?MultiplyAndLog@@YAXHH@Z DD imagerel $LN3
	DD	imagerel $LN3+92
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?MultiplyAndLog@@YAXHH@Z DD 025051601H
	DD	01112316H
	DD	0700a0021H
	DD	05009H
xdata	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?LogMultiply@@YAXH@Z DD 025051201H
	DD	010d2312H
	DD	07006001dH
	DD	05005H
xdata	ENDS
...
result$ = 4
main	PROC						; COMDAT
; File C:\Dev\CppSeries\HelloWorld\Main.cpp
; Line 21
$LN3:
	push	rbp
	push	rdi
	sub	rsp, 264				; 00000108H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__A8ECA010_Main@cpp
	call	__CheckForDebuggerJustMyCode
; Line 45
	mov	edx, 8
	mov	ecx, 7
...
; Line 47
	mov	ecx, DWORD PTR result$[rbp]
	call	?LogMultiply@@YAXH@Z			; LogMultiply
; Line 49
	mov	edx, 3
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?LogMultiply@@YAXH@Z
_TEXT	SEGMENT
a$ = 224
?LogMultiply@@YAXH@Z PROC				; LogMultiply, COMDAT
; File C:\Dev\CppSeries\HelloWorld\Main.cpp
; Line 9
$LN3:
	mov	DWORD PTR [rsp+8], ecx
...
; Line 11
	...
	pop	rbp
	ret	0
?LogMultiply@@YAXH@Z ENDP				; LogMultiply
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
